...
|---------|-----------|---------|
| Filenames | kebab-case | `machine-learning.md` |
...
Create or update `wiki/meta/dashboard.md` with these queries (requires the Dataview community plugin; the page degrades gracefully without it):
